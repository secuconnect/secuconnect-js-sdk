...
*/
var PaymentSecupaySofortApi = function () {
  ...
  */
  function PaymentSecupaySofortApi(apiClient) {
    _classCallCheck(this, PaymentSecupaySofortApi);
  ...
  _createClass(PaymentSecupaySofortApi, [{
    ...
    key: 'paymentSecupaySofortGetByIdWithHttpInfo',
    value: function paymentSecupaySofortGetByIdWithHttpInfo(paymentPrepayId) {
      var postBody = null;
      ...
      return this.apiClient.callApi('/Payment/Secupaysofort/{paymentPrepayId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: 'paymentSecupaySofortGetById',
    value: function paymentSecupaySofortGetById(paymentPrepayId) {
      return this.paymentSecupaySofortGetByIdWithHttpInfo(paymentPrepayId).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    key: 'paymentSecupaysofortPostWithHttpInfo',
    value: function paymentSecupaysofortPostWithHttpInfo(opts) {
      opts = opts || {};
      var postBody = opts['body'];
      ...
      return this.apiClient.callApi('/Payment/Secupaysofort', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType);
    }
    ...
    key: 'paymentSecupaysofortPost',
    value: function paymentSecupaysofortPost(opts) {
      return this.paymentSecupaysofortPostWithHttpInfo(opts).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
  ...
  return PaymentSecupaySofortApi;
}();

exports.default = PaymentSecupaySofortApi;