...
var PaymentContractsApi = function () {
  ...
  */
  ...
  _createClass(PaymentContractsApi, [{
    ...
    key: 'paymentContractsIdClonePostWithHttpInfo',
    value: function paymentContractsIdClonePostWithHttpInfo(paymentContractId) {
      var postBody = null;
    ...
    key: 'paymentContractsIdClonePost',
    value: function paymentContractsIdClonePost(paymentContractId) {
      return this.paymentContractsIdClonePostWithHttpInfo(paymentContractId).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    ...
    key: 'paymentContractsIdRequestIdPostWithHttpInfo',
    value: function paymentContractsIdRequestIdPostWithHttpInfo(paymentContractId) {
      var postBody = null;
    ...
    key: 'paymentContractsIdRequestIdPost',
    value: function paymentContractsIdRequestIdPost(paymentContractId) {
      return this.paymentContractsIdRequestIdPostWithHttpInfo(paymentContractId).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
