...
export default class PaymentTransactionsApi {
    ...
    */
     ...
     */
    paymentTransactionsGetByIdWithHttpInfo(id) {
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling paymentTransactionsGetById");
      }
     ...
     */
    paymentTransactionsGetById(id) {
      return this.paymentTransactionsGetByIdWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    paymentTransactionsIdCancelPostWithHttpInfo(id) {
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling paymentTransactionsIdCancelPost");
      }
      ...
      return this.apiClient.callApi(
        'Payment/Transactions/{id}/cancel', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    paymentTransactionsIdCancelPost(id) {
      return this.paymentTransactionsIdCancelPostWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    paymentTransactionsIdShippingUrlGetWithHttpInfo(id) {
      let postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling paymentTransactionsIdShippingUrlGet");
      }
      ...
      return this.apiClient.callApi(
        'Payment/Transactions/{id}/ShippingUrl', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    paymentTransactionsIdShippingUrlGet(id) {
      return this.paymentTransactionsIdShippingUrlGetWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
